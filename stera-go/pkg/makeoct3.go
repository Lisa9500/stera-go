...
func MakeOct3(XY [][]float64, order map[string]int) (cord [][]float64, rect1List [][]float64, rect2List [][]float64, rect3List [][]float64) {
	...
	if divLine1a < divLine1b {
		...
		if divLine2a < divLine2b {
			...
			// 四角形L1-D2-R3-D1
			rect2name = []string{"L1", "D2", "R3", "D1"}
			// 四角形R1-R2-D2-L2
			rect3name = []string{"R1", "R2", "D2", "L2"}
			...
			// 四角形L1-L2-D2-D1
			rect2name = []string{"L1", "L2", "D2", "D1"}
			// 四角形R1-R2-R3-D2
			rect3name = []string{"R1", "R2", "R3", "D2"}
		}

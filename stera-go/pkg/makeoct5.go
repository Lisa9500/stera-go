...
func MakeOct5(XY [][]float64, order map[string]int) (cord [][]float64, rect1List [][]float64, rect2List [][]float64, rect3List [][]float64) {
	...
	if (taikoCord1a[0][1] < int1aX && int1aX < taikoCord1a[1][1]) || (taikoCord1a[0][1] > int1aX && int1aX > taikoCord1a[1][1]) {
		// 交点1aまでの距離
	...
	if (taikoXYb[0][1] < int1aX && int1aX < taikoXYb[1][1]) || (taikoXYb[0][1] > int1aX && int1aX > taikoXYb[1][1]) {
		// 交点2bまでの距離
		divLine2b = DistVerts(XY[num2][1], int1aX, XY[num2][0], int1aY)
